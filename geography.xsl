...
<xsl:transform xmlns:xsl="http://www.w3.org/1999/XSL/Transform"	version="1.0">
	...
	<xsl:template match="/">
		<html>
			...
			<body>
				...
				<xsl:apply-templates select="/Database/subject/title[text()='Geography']/../paper/paper1"/>
				<h4></h4>
				...
				<xsl:apply-templates select="/Database/subject/title[text()='Geography']/../exam/description"/>
				<h3>What are the dates of the exams?</h3>
				<xsl:apply-templates select="/Database/subject/title[text()='Geography']/../exam/date"/>
				<h3>What time do the exams start at?</h3>
				<xsl:apply-templates select="/Database/subject/title[text()='Geography']/../exam/time"/>
	...
	<xsl:template match="paper1">
		<a href="https://www.examinations.ie/tmp/1449235771_7959180.pdf">
		<xsl:value-of select="."/>
		</a>
	</xsl:template>
	
	<xsl:template match="paper2">
		<a href="https://www.examinations.ie/tmp/1449236503_8250358.pdf">
		<xsl:value-of select="."/>
		</a>
	</xsl:template>
	...
	<xsl:template match="resource1">
		<a href="http://lcgeography.preswex.ie/">
		<xsl:value-of select="."/>
		</a>
	</xsl:template>
	
	<xsl:template match="resource2">
		<a href="http://www.studynotes.ie/leaving-cert/geography/">
		<xsl:value-of select="."/>
		</a>
	</xsl:template>
